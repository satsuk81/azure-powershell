...
$RGNameUAT = "rg-wl-uat-eucpackaging"                                                 # UAT Resource group name
...
$VmNamePrefix = "euc-van-"                                            # Specifies the first part of the VM name (usually alphabetic)
...
$VmImage = "MicrosoftWindowsDesktop:Windows-10:20h1-ent:latest"     # Specifies the Publisher, Offer, SKU and Version of the image to be used to provision the VM
