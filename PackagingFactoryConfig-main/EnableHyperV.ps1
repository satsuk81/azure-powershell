...
$Result2 = Get-AzStorageBlobContent -Container data -Blob "Media\Vanilla-Windows10-Base.vhdx" -Destination "F:\Hyper-V\Virtual Hard Disks" -Context $StorAcc.context
